...
<template>
  <v-snackbar v-if="snackbar.active" v-model="snackbar.active" position="fixed"
    :color="snackbar?.type === 'error' ? 'red' : 'green'" location="bottom right" :timeout="snackbar.timeout"
